...
1. Open a second terminal window and run: **passwd**
1. Look at the first terminal window, you'll see a process come up for passwd. The first column in the process table is the effective user ID, lo and behold it's the root user!

>>Q1: What UID decides what access to grant?<<
=== effective
